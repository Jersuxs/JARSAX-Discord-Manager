/*
 * JarsaxDM, a modification for Discord's desktop app
...
function Updater() {
    ...
    return (
        <SettingsTab title="JarsaxDM Updater">
            <Forms.FormTitle tag="h5">Updater Settings</Forms.FormTitle>
            <Switch
                value={settings.autoUpdate}
                onChange={(v: boolean) => settings.autoUpdate = v}
                note="Automatically update JarsaxDM without confirmation prompt"
            >
            ...
            <Switch
                ...
                note="Shows a notification when JarsaxDM automatically updates"
